...
const ProdAuditTrailView: React.FC = () => {
    return (
        <div>
            <h1 className="text-3xl font-bold text-gray-800 mb-6">Audit Trail (Full Production Visibility)</h1>
...
export default ProdAuditTrailView;